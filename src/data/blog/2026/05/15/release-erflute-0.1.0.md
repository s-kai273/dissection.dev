...
技術スタックとして、Tauriを使うことでデスクトップあぷりとして構築し、バックエンドRust、フロントエンドTypeScript + Reactで実装をしています。  
...
またeclipse版erfluteにはなかった機能として、マウスやトラックパッドの操作により画面移動や画面の拡大縮小が行えるようになりました。  
